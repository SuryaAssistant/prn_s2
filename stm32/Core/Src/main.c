...
#define presc 8				// Timer 2 prescale
...
// Isolated Buck Converter Properties
int maxIsolatedBuckValue = 144;
int nowIsolatedBuckValue = 0;

// Boost Converter Properties
int maxBoostValue = 288;
int nowBoostValue = 0;

// Input Voltage Properties
